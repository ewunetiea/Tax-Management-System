...
public interface RoleMapper {
	...
	@Results(value = {
			...
			@Result(property = "jobPositions", javaType = List.class, column = "id", many = @Many(select = "com.tms.Admin.Mapper.JobPositionMapper.getJobPositionsByRoleIdList"))
	})
	...
	@Results(value = {
			@Result(property = "id", column = "id"),
			@Result(property = "functionalities", javaType = List.class, column = "id", many = @Many(select = "com.tms.Common.Permission.Mapper.FunctionalitiesMapper.getFunctionalitiesByRole"))
	})
