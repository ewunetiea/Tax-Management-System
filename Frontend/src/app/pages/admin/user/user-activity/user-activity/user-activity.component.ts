...
@Component({
  ...
  imports: [CommonModule, TableModule, FormsModule, CardModule, ToolbarModule, ToastModule, TimeagoModule, IconFieldModule, InputIconModule,SelectButton, BreadcrumbModule, InputTextModule, ButtonModule],
