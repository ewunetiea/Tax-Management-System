...
@Service
public class CreditDocumentationNewService {
        ...
        public List<ISManagementAuditDTO> getISReport(CreditDocumentationReport isReport) {
        ...
        public boolean checkAuditPeriodDates(CreditDocumentationReport isReport, int index) {
        ...
        public boolean checkAmounts(CreditDocumentationReport isReport, int index) {
        ...
        public boolean checkRectificationDates(CreditDocumentationReport isReport, int index) {
        ...
        public boolean checkDraftedDates(CreditDocumentationReport isReport, int index) {
        ...
        public boolean checkReviewedDates(CreditDocumentationReport isReport, int index) {
        ...
        public boolean checkLoanGrantedDates(CreditDocumentationReport isReport, int index) {
                if (isReport.getLoanGrantedDate() != null) {
                        if (index == 0)
                                return isReport.getLoanGrantedDate().size() > 0;
                        return isReport.getLoanGrantedDate().size() > 1;
                }
                return false;
        }

        public boolean checkLoanSetlmentDates(CreditDocumentationReport isReport, int index) {
                if (isReport.getLoanSetlmentDate() != null) {
                        if (index == 0)
                                return isReport.getLoanSetlmentDate().size() > 0;
                        return isReport.getLoanSetlmentDate().size() > 1;
                }
                return false;
        }
        ...
        public boolean checkApprovedDates(CreditDocumentationReport isReport, int index) {
        ...
        public boolean checkRespondedDates(CreditDocumentationReport isReport, int index) {
