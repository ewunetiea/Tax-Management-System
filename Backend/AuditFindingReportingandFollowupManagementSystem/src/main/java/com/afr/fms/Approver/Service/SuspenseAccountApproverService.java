...
import com.afr.fms.Approver.Mapper.SuspenseAccountApproverMapper;
...
@Service
public class SuspenseAccountApproverService {
   ...
   private  SuspenseAccountApproverMapper suspenseAccountApproverMapper;
    ...
    private AuditeeDivisionISMMapper auditeeDivisionISMMapper;
       ...
       public List<AuditISM> getFindingBasedOnStatus(PaginatorPayLoad paginatorPayload) {
        ...
        if (paginatorPayload.getAudit_status().equalsIgnoreCase("pending")) {
            IsMgtAudit = suspenseAccountApproverMapper.getPendingSuspenseAccount(paginatorPayload);
        } 
        else if (paginatorPayload.getAudit_status().equalsIgnoreCase("approved")) {
          

            IsMgtAudit = suspenseAccountApproverMapper.getApprovedSuspenseAccount(paginatorPayload);
        }
        
        else if (paginatorPayload.getAudit_status().equalsIgnoreCase("rejected")) {
            IsMgtAudit = suspenseAccountApproverMapper.getRejectedFindings(paginatorPayload);
        }
