...
import com.afr.fms.Auditor.Mapper.LongOutstandingItemsAuditorMapper;
...
public class LongOutstandingItemsAuditorService {
    @Autowired
    private LongOutstandingItemsAuditorMapper longOutstandingItemsAuditorMapper;
    ...
    public void createLongOutstandingItemsFinding(AuditISM audit) {
        ...
        audit.getLongOutstandingItems().setMgt_audit_id(audit_id);
        longOutstandingItemsAuditorMapper.createLongOutstandingItemsFinding(audit.getLongOutstandingItems());
    ...
    public void updateLongOutstandingItemsFinding(AuditISM audit) {
        User user = userMapper.getAuditorById(audit.getAuditor().getId());
        if (audit.getFinding_detail() == null) {
            longOutstandingItemsAuditorMapper.updateMGTFinding(audit);
            longOutstandingItemsAuditorMapper.updateLongOutstandingItemsFinding(audit.getLongOutstandingItems());
        } else {
            longOutstandingItemsAuditorMapper.updateMGTFindingandFindingDetail(audit);
            longOutstandingItemsAuditorMapper.updateLongOutstandingItemsFinding(audit.getLongOutstandingItems());
        }
    ...
    public List<AuditISM> getAuditsOnDrafting(PaginatorPayLoad paginatorPayload) {
        ...
        List<AuditISM> inspectionAudits = longOutstandingItemsAuditorMapper.getAuditsOnDrafting(paginatorPayload);
    ...
    public List<AuditISM> getPassedAuditFindings(PaginatorPayLoad paginatorPayload) {
        // PageHelper.startPage(paginatorPayload.getCurrentPage(), paginatorPayload.getPageSize());
        List<AuditISM> inspectionAudits = longOutstandingItemsAuditorMapper.getPassedAuditFindings(paginatorPayload);
        // if (!inspectionAudits.isEmpty()) {
        //     Page<AuditISM> page = (Page<AuditISM>) inspectionAudits;
        //     inspectionAudits.get(0).setTotal_records_paginator(page.getTotal());
        // }
    ...
    public List<AuditISM> geRejectedFindings(PaginatorPayLoad paginatorPayload) {
        // PageHelper.startPage(paginatorPayload.getCurrentPage(), paginatorPayload.getPageSize());
        List<AuditISM> inspectionAudits = longOutstandingItemsAuditorMapper.getRejectedFindings(paginatorPayload);
        // if (!inspectionAudits.isEmpty()) {
        //     Page<AuditISM> page = (Page<AuditISM>) inspectionAudits;
        //     inspectionAudits.get(0).setTotal_records_paginator(page.getTotal());
        // }
