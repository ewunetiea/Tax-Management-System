...
public interface ManageTaxApproverMapper {
    ...
    @Update("UPDATE tblTaxable SET status = 3, approver_rejected_reason = #{approver_rejected_reason}, rejector_approver_id = #{user_id}, approver_rejected_date = CURRENT_TIMESTAMP WHERE id = #{id}")
