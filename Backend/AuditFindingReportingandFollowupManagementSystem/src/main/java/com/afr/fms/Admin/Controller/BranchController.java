...
public class BranchController {
	...
	public ResponseEntity<List<Branch>> getBranches(@RequestBody PaginatorPayLoad paginatorPayLoad,
			HttpServletRequest request) {
		List<Branch> branch = branchService.getBranches(paginatorPayLoad);
		logger.info("Successfully retrieved {} branches for auditor ID: {}", branch.size(),
