...
export class ReplaceHRDataComponent {
    ...
    replaceHRData() {
        this.confirmationService.confirm({
            message: 'Are you certain you want to proceed with updating the HR data for AFRFMS?',
            header: 'Confirm',
            ...
            accept: () => {
                ...
                this.userService.replaceHRData().subscribe({
                    ...
                    error: (error: HttpErrorResponse) => {
                        ...
                        this.messageService.add({
                            severity: 'error',
                            summary: error.status == 401 ? 'You are not permitted to perform this action!' : 'Something went wrong while updating HR Data!',
                            detail: ''
                        });
                    }
                });
