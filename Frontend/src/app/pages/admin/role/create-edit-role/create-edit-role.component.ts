...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, DialogModule, ButtonModule, InputTextModule, InputText, CardModule, ConfirmDialogModule, RadioButton, ToggleSwitch, TextareaModule, MessageModule],
