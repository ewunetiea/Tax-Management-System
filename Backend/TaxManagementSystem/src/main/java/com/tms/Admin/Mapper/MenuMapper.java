...
public interface MenuMapper {
	...
	@Results(value = {
			...
			@Result(property = "menuHeaders", javaType = List.class, column = "id", one = @One(select = "com.tms.Admin.Mapper.MenuMapper.getMenuHeadersByItemID")),
			@Result(property = "permissions", javaType = List.class, column = "id", many = @Many(select = "com.tms.Common.Permission.Mapper.FunctionalitiesMapper.getAllFunctionalitiesByMenuItem"))
	...
	@Results(value = {
			@Result(property = "id", column = "id"),
			@Result(property = "menuItems", javaType = List.class, column = "id", many = @Many(select = "com.tms.Admin.Mapper.MenuMapper.getMenuItemsByHeaderIDNew")),
			@Result(property = "roles", javaType = List.class, column = "id", many = @Many(select = "com.tms.Admin.Mapper.RoleMapper.getRoleByHeaderID")),
	})
	...
	@Results(value = {
			@Result(property = "id", column = "id"),
			@Result(property = "menuItems", javaType = List.class, column = "id", many = @Many(select = "com.tms.Admin.Mapper.MenuMapper.getMenuItemsByHeaderIDDynamicNew"))
	})
