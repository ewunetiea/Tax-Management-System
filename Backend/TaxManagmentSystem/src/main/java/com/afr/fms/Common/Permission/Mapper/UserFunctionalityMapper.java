...
public interface UserFunctionalityMapper {
        ...
        @Results(value = {
                        ...
                        @Result(property = "functionalities", javaType = List.class, column = "id", many = @Many(select = "com.afr.fms.Common.Permission.Mapper.UserFunctionalityMapper.getUserFunctionalitiesById"))
        })
