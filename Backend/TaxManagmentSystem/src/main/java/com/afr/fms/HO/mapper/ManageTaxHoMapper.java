...
public interface ManageTaxHoMapper {
    ...
    @Update("UPDATE tblTaxable SET status = 2, approver_rejected_reason = #{checker_rejected_reason}, rejector_approver_id = #{user_id}, approver_rejected_date = CURRENT_TIMESTAMP WHERE id = #{id}")
