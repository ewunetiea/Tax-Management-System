...
public interface UserMapper {
        ...
        @Results(value = {
                        ...
                        @Result(property = "jobPosition", column = "job_position_id", one = @One(select = "com.tms.Admin.Mapper.JobPositionMapper.getJobPositionById")),
                        @Result(property = "region", column = "region_id", one = @One(select = "com.tms.Admin.Mapper.RegionMapper.getRegionById")),
                        @Result(property = "branch", column = "branch_id", one = @One(select = "com.tms.Admin.Mapper.BranchMapper.getBranchById")),
                        @Result(property = "user_security", column = "id", one = @One(select = "com.tms.Security.UserSecurity.mapper.UserSecurityMapper.getUserSecurityInfoByUserId")),
                        @Result(property = "userCopyFromHR", column = "emp_id", one = @One(select = "com.tms.Admin.Mapper.CopyHRUsersMapper.checkUserEmployeeId")),
                        @Result(property = "roles", javaType = List.class, column = "id", many = @Many(select = "com.tms.Admin.Mapper.UserRoleMapper.getRolesByUserId"))
        })
        ...
        @Results(value = {
                        ...
                        @Result(property = "photoUrl", column = "photo_url"),
                        @Result(property = "branch", column = "branch_id", one = @One(select = "com.tms.Admin.Mapper.BranchMapper.getBranchById")),
                        @Result(property = "roles", javaType = List.class, column = "id", many = @Many(select = "com.tms.Admin.Mapper.RoleMapper.getRolesByUserId")),
                        @Result(property = "region", column = "region_id", one = @One(select = "com.tms.Admin.Mapper.RegionMapper.getRegionById")),
                        @Result(property = "jobPosition", column = "job_position_id", one = @One(select = "com.tms.Admin.Mapper.JobPositionMapper.getJobPositionById")),
                        @Result(property = "user_security", column = "id", one = @One(select = "com.tms.Security.UserSecurity.mapper.UserSecurityMapper.getUserSecurityInfoByUserId")),
                        @Result(property = "userCopyFromHR", column = "emp_id", one = @One(select = "com.tms.Admin.Mapper.CopyHRUsersMapper.checkUserEmployeeId"))
        ...
        @Results(value = {
                        @Result(property = "id", column = "id"),
                        @Result(property = "employee_id", column = "emp_id"),
                        @Result(property = "userCopyFromHR", column = "emp_id", one = @One(select = "com.tms.Admin.Mapper.CopyHRuserMapper.checkUserEmployeeId")),
                        @Result(property = "branch", column = "branch_id", one = @One(select = "com.tms.Admin.Mapper.BranchMapper.getBranchById")),
                        @Result(property = "region", column = "region_id", one = @One(select = "com.tms.Admin.Mapper.RegionMapper.getRegionById")),
                        @Result(property = "photoUrl", column = "photo_url"),
                        @Result(property = "jobPosition", column = "job_position_id", one = @One(select = "com.tms.Admin.Mapper.JobPositionMapper.getJobPositionById")),
