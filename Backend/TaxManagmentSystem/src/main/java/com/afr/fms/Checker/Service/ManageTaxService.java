package com.afr.fms.Checker.Service;
...
import com.afr.fms.Checker.Mapper.ManageTaxMapper;
...
@Service
public class ManageTaxService {

    @Autowired
    private ManageTaxMapper manageTaxMapper;
